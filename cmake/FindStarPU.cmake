...
if(NOT STARPU_DIR AND DEFINED ENV{STARPU_DIR})
  set(STARPU_DIR
      $ENV{STARPU_DIR}
      CACHE PATH "Root directory of StarPU installation")
endif()

if(NOT STARPU_DIR)
  message(
    FATAL_ERROR "Please set the STARPU_DIR environment variable or cache entry")
endif()
...
set_target_properties(
  StarPU::starpu
  PROPERTIES IMPORTED_LOCATION "${STARPU_LIBRARY}" INTERFACE_INCLUDE_DIRECTORIES
                                                   "${STARPU_INCLUDE_DIR}")
