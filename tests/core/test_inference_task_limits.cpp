...
class InferenceTaskLimitsTest : public ::testing::Test {
 protected:
  void SetUp() override
  {
...
TEST_F(InferenceTaskLimitsTest, CheckLimitsTooManyInputs)
{
...
TEST_F(InferenceTaskLimitsTest, FillInputLayoutTooManyDims)
{
